    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Daftar Surah',
            style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.teal), // Header lebih kecil
          ),
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        ...
                        title: Text(
                          ...
                          style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500), // Ukuran teks lebih kecil
                        ),
                        subtitle: Text(
                        ...
                        trailing: CircleAvatar(
                          ...
                          backgroundColor: Colors.teal, // Warna lingkaran tetap teal
                          child: Text(
